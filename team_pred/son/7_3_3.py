...
dataset_paths = ['son_file/image/tedy-front/', 'son_file/image/son-front/', 'son_file/image/unknown-front/']
output_paths = ['son_file/image/tedy-align/', 'son_file/image/son-align/', 'son_file/image/unknown-align/']
number_images = 20
image_type = '.jpg'
