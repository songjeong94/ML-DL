...
face_cascade = cv2.CascadeClassifier('./study/team_pred/haarcascade_frontalface_default.xml')
# face_cascade.load('./study/team_pred/haarcascade_frontalface_default.xml')
