...
X_data = np.loadtxt('D:/Study/data/dacon/comp2/train_features.csv',skiprows=1,delimiter=',')
X_data = X_data[:,1:]
print(X_data.shape)
     
    
Y_data = np.loadtxt('D:/Study/data/dacon/comp2/train_target.csv',skiprows=1,delimiter=',')
Y_data = Y_data[:,1:]
print(Y_data.shape)
...
X_data_test = np.loadtxt('D:/Study/data/dacon/comp2/test_features.csv',skiprows=1,delimiter=',')
...
submit = pd.read_csv('D:\Study\data\dacon\comp2\sample_submission.csv')
...
submit.to_csv('./data/dacon/comp2/comp2_0630.csv', index = False)
