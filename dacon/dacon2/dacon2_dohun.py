...
X_data = np.loadtxt('D:/study/data/dacon/comp2/KAERI_dataset/train_features.csv',skiprows=1,delimiter=',')
X_data = X_data[:,1:]
print(X_data.shape)
     
    
Y_data = np.loadtxt('D:/study/data/dacon/comp2/KAERI_dataset/train_target.csv',skiprows=1,delimiter=',')
Y_data = Y_data[:,1:]
print(Y_data.shape)
...
X_data_test = np.loadtxt('D:/study/data/dacon/comp2/KAERI_dataset/test_features.csv',skiprows=1,delimiter=',')
...
submit = pd.read_csv('D:\study\data\dacon\comp2\KAERI_dataset\sample_submission.csv')
