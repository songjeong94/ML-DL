...
from keras.applications import VGG16, VGG19, ResNet101, InceptionV3
...
incept = InceptionV3(include_top=False, weights='imagenet', input_shape=ishape)   # (None, 224, 224, 3)
# vgg16.summary()
