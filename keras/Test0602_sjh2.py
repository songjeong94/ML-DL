...
x1_train_scaled = x1_train_scaled.reshape(228,5,1)
x1_test_scaled = x1_test_scaled.reshape(26,5,1)
x2_train_scaled = x2_train_scaled.reshape(228,5,1)
x2_test_scaled = x2_test_scaled.reshape(26,5,1)
...
dense1 = LSTM(1005, activation='relu')(input1)
dense2 = Dense(1000, activation='relu')(dense1)
...
model.fit([x1_train_scaled, x2_train_scaled], [y1_train,y2_train] ,epochs=50, batch_size=1, validation_split=(0.25), verbose=1)
...
y1_predict, y2_predict = model.predict([x1_test_scaled, x2_test_scaled])
