...
hist = model.fit(x_train, y_train, epochs=10, validation_split=0.1,callbacks=[early, cp])

loss,acc = model.evaluate(x_test, y_test, batch_size = 10, vaildation_split = 0.2)
