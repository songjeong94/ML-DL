...
loss1,loss2,loss3, mse1,mse2 = model.evaluate([x1_test, x2_test],[y1_test, y2_test], batch_size=1) #x,y를 평가하여 loss와 acc에 반환하겠다.
print("loss1 : ", loss1)
print("loss2 : ", loss2)
print("loss3 : ", loss3)
print("mse1 : ", mse1)
