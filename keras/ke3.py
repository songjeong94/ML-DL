...
model.save('./model/sample/fashion_mnist/fashion_model_save.h5') # 모델 세이브
#model = load_model('./model/sample/fashion_mnsit/fashion_mnist_checkpoint_best.hdf5')


model.save_weights('./model/sample/fashion_mnist/fashion_mnist_weight.h5')

model.compile(loss="categorical_crossentropy", optimizer='adam', metrics=['acc'])
model.fit(x_train,y_train, epochs = 30, validation_split=0.2)

modelpath = './model/sample/fashion_mnist/{epoch:02d} - {val_loss:.4f}.hdf5'     # d : decimal, f : float
