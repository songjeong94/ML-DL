...
x_train = train[feature_names] # x_train의 피쳐개수를 테스트와 맞춰준다. (71개)
x_test = test[feature_names]   # x_test의 피쳐개수를 테스트와 맞춰준다.  (71개)
print(x_train.shape, x_test.shape)
# (10000, 71) (10000, 71)

y_train = train[target_names]  #y_train 의 피쳐를 타겟과 동일하게 맞춘다.
...
pred.to_csv(path + '/comp1/sample_submission.csv')