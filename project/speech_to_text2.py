...
#Second Conv1D layer
conv = Conv1D(100, 11, padding='same', activation='relu')(conv)
conv = MaxPooling1D(3)(conv)
conv = Dropout(0.3)(conv)

#Third Conv1D layer
conv = Conv1D(100, 9, padding='same', activation='relu')(conv)
conv = MaxPooling1D(3)(conv)
conv = Dropout(0.3)(conv)

#Fourth Conv1D layer
conv = Conv1D(128, 7, padding='same', activation='relu')(conv)
conv = MaxPooling1D(3)(conv)
conv = Dropout(0.3)(conv)
...
mc = ModelCheckpoint('./project/data/best_model.hdf5', monitor='val_acc', verbose=1, save_best_only=True, mode='max')
